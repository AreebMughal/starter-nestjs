...
export class NewMigrations1687426826151 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tbl_user_role_enum_old" AS ENUM('SUPER_ADMIN', 'ADMIN', 'USER')`);
        await queryRunner.query(`ALTER TABLE "tbl_user" ALTER COLUMN "role" TYPE "public"."tbl_user_role_enum_old" USING "role"::"text"::"public"."tbl_user_role_enum_old"`);
        ...
        await queryRunner.query(`ALTER TYPE "public"."tbl_user_role_enum_old" RENAME TO "tbl_user_role_enum"`);
        await queryRunner.query(`ALTER TABLE "tbl_user" ADD "phone" text`);
        await queryRunner.query(`ALTER TABLE "tbl_user" ADD CONSTRAINT "UQ_862aae9dfe1a6534b7fa8b6a3e9" UNIQUE ("phone")`);
        await queryRunner.query(`ALTER TABLE "tbl_user" ADD "user_name" text`);
        await queryRunner.query(`ALTER TABLE "tbl_user" ADD CONSTRAINT "UQ_0a59bafa265a3130ee6ed8431e9" UNIQUE ("user_name")`);
